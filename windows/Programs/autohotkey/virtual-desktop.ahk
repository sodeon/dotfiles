...
; _CurrentApp      := "" ; always update to date active window process ID
; _PreviousApp     := "" ; last active window process ID different from current one
...
mapDesktopsFromRegistry() {
   global _CurrentDesktop, DesktopCount
...
createVirtualDesktop() {
   ...
   Send, #^d
   DesktopCount++
   _CurrentDesktop = %DesktopCount%
   OutputDebug, [create] desktops: %DesktopCount% current: %_CurrentDesktop%
}
;
...
deleteVirtualDesktop()
{
    ...
    DesktopCount--
    _CurrentDesktop--
    OutputDebug, [delete] desktops: %DesktopCount% current: %_CurrentDesktop%
}
